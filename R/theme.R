...
theme_wjake_shiny <- shinyDashboardThemeDIY(
  ...
  ,primaryFontColor = "rgb(0,159,183)"
  ...
  ### header
  ,logoBackColor = "#272727"

  ,headerButtonBackColor = "#272727"
  ,headerButtonIconColor = "#009FB7"
  ,headerButtonBackColorHover = "rgb(100,100,100)"
  ,headerButtonIconColorHover = "rgb(60,60,60)"

  ,headerBackColor = "#272727"
